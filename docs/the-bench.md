...
![The platform Deploy page — paste your agent id to register it](images/platform-deploy.png)
...
![The platform Run & Submit page — run a trial, or lock your final submission](images/platform-run-submit.png)
...
your pitch all count. Reach out to the organizers when you
